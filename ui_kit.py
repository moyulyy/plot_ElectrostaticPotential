...
class SegmentedControl(QWidget):
    ...
    def set_item_enabled(self, key, enabled):
        if key in self._buttons:
            self._buttons[key].setEnabled(bool(enabled))

    def item_enabled(self, key):
        return key in self._buttons and self._buttons[key].isEnabled()
