...
| 📏 | **等值面水平可调**：密度水平（e/Å³，常用 0.1）滑杆 + 数值框实时联动 |
...
| VESTA 参考（俯视） | 本程序（俯视） |
| :---: | :---: |
| ![](docs/vesta_top.png) | ![](docs/screenshot_top.png) |

| VESTA 参考（侧视） | 本程序（正视） |
| :---: | :---: |
| ![](docs/vesta_side.png) | ![](docs/screenshot_side.png) |
...
4. **导出 PNG 失败** → 极少数显卡驱动下 WebGL 取图受限，可改用系统截图。
